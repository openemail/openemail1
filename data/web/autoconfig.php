...
<clientConfig version="1.1">
    <emailProvider id="<?=$openemail_hostname; ?>">
      <domain>%EMAILDOMAIN%</domain>
      <displayName>A openemail mail server</displayName>
...
<?php } ?>
      ...
      <enable visiturl="https://<?=$openemail_hostname; ?><?php if ($port != 443) echo ':'.$port; ?>/admin.php">
    ...
    <webMail>
      <loginPage url="https://<?=$openemail_hostname; ?><?php if ($port != 443) echo ':'.$port; ?>/SOGo/" />
    </webMail>
</clientConfig>
