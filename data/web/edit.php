...
if (!isset($_SESSION['openemail_cc_role']) OR !in_array($_SESSION['openemail_cc_role'], $AuthUsers)) {
	header('Location: /');
	exit();
}
...
if (isset($_SESSION['openemail_cc_role'])) {
        ...
        ?>
          ...
          <form data-id="editdomain" class="form-horizontal" role="form" method="post">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                  <label><input type="checkbox" value="1" name="active" <?=(isset($result['active_int']) && $result['active_int']=="1") ? "checked" : null;?> <?=($_SESSION['openemail_cc_role'] == "admin") ? null : "disabled";?>> <?=$lang['edit']['active'];?></label>
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  if ($_SESSION['openemail_cc_role'] == "admin"  || $_SESSION['openemail_cc_role'] == "domainadmin" || $_SESSION['openemail_cc_role'] == "user") {
