...
$lang['add']['alias_address_info'] = '<small>Полный почтовый адрес(а) или @example.com, чтобы поймать все сообщения для домена (разделенных запятыми). <b>только домены openemail</b>.</small>';
