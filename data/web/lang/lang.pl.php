...
$lang['footer']['restart_sogo_info'] = 'Niektóre zadania, np. dodanie domeny, wymagają ponownego uruchomienia SOGo, aby zastosować zmiany wprowadzone do openemail UI.<br><br><b>Important:</b> Bezpieczne, ponowne uruchomienie może chwilę potrwać, proszę czekać do zakończenia procesu.';
...
$lang['start']['mailcow_apps_detail'] = 'Użyj aplikacji openemail, aby mieć dostęp do wiadomości, kalendarza, kontaktów i innych.';
...
$lang['add']['alias_address_info'] = '<small>Pełny/e adres/y email lub @example.com, aby przejąć wszystkie wiadomości dla domeny (oddzielone przecinkami). <b>tylko domeny openemail</b>.</small>';
...
$lang['tfa']['api_register'] = 'openemail używa Yubico Cloud API. Proszę pobrać klucz API dla Twojego klucza <a href="https://upgrade.yubico.com/getapikey/" target="_blank">here</a>';
