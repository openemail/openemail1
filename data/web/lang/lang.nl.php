...
$lang['start']['mailcow_apps_detail'] = 'Gebruik een openemail-app om je e-mails, agenda, contacten en meer te bekijken.';
...
$lang['edit']['force_pw_update_info'] = 'Deze gebruiker kan hierdoor enkel inloggen op openemail UI, totdat de procedure succesvol doorlopen is.';
...
$lang['add']['alias_address_info'] = '<small>Volledig(e) e-mailadres(sen) of @example.com, om een catch-all aan te maken voor een domein (kommagescheiden). <b>Enkel openemail-domeinen</b>.</small>';
...
$lang['tfa']['api_register'] = 'openemail maakt gebruik van de Yubico Cloud API. Om dit te benutten heeft u een API-sleutel van Yubico nodig, deze kunt u <a href="https://upgrade.yubico.com/getapikey/" target="_blank">hier</a> opvragen';
$lang['tfa']['u2f'] = "U2F";
...
$lang['admin']['title_name'] = '"openemail" (website-titel)';
$lang['admin']['main_name'] = '"openemail"';
$lang['admin']['apps_name'] = '"opememail-apps"';
