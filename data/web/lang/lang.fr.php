...
$lang['footer']['restart_sogo_info'] = "Certaines taches, par exemple l'ajout d'un domaine, nécessite le redémarrage de SOGo afin de propager les changements faits dans openemail UI.<br><br><b>Important :</b> un redémarrage doux peut prendre du temps à s'effectuer complètement, merci d'attendre qu'il se termine.";
...
$lang['start']['mailcow_apps_detail'] = "Utiliser l'application openemail pour accéder à vos courriels, calendriers, contacts et bien plus.";
...
$lang['add']['alias_address_info'] = "<small>Adresse de courriel complète ou @exemple.com pour recevoir tous les messages d'un domaine (séparés par de virgules). <b>Domaines openemail seulement</b></small>";
...
$lang['tfa']['api_register'] = "openemail utilise Yubico Cloud API. Merci d'obtenir un clé API pour votre clé <a href=\"https://upgrade.yubico.com/getapikey/\" target=\"_blank\">ici</a>";
