...
if (isset($_SESSION['openemail_cc_role']) && isset($_SESSION['oauth2_request'])) {
  $oauth2_request = $_SESSION['oauth2_request'];
  unset($_SESSION['oauth2_request']);
  header('Location: ' . $oauth2_request);
  exit();
}
elseif (isset($_SESSION['openemail_cc_role']) && $_SESSION['openemail_cc_role'] == 'admin') {
  header('Location: /admin');
  exit();
}
elseif (isset($_SESSION['openemail_cc_role']) && $_SESSION['openemail_cc_role'] == 'domainadmin') {
  header('Location: /mailbox');
  exit();
}
elseif (isset($_SESSION['openemail_cc_role']) && $_SESSION['openemail_cc_role'] == 'user') {
    ...
    <div class="col-md-offset-3 col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="text-center openemail-logo"><img src="<?=($main_logo = customize('get', 'main_logo')) ? $main_logo : '/img/openemail.png';?>" alt="openemail"></div>
          <legend><?= isset($_SESSION['oauth2_request']) ? $lang['oauth2']['authorize_app'] : $UI_TEXTS['main_name'];?></legend>
            ...
            <div class="form-group">
              ...
              <div class="btn-group pull-right">
                <button type="button" <?=(isset($_SESSION['openemail_locale']) && count($AVAILABLE_LANGUAGES) === 1) ? 'disabled="true"' : '' ?> class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="lang-sm lang-lbl" lang="<?= $_SESSION['openemail_locale']; ?>"></span> <span class="caret"></span>
                </button>
      ...
      <div class="panel panel-default">
        ...
        <div id="collapse1" class="panel-collapse collapse">
          <div class="panel-body">
            ...
            <p><?= $lang['start']['openemail_panel_detail']; ?></p>
            <p><span style="border-bottom: 1px dotted #999;"><?=$UI_TEXTS['apps_name'];?></span></p>
            <p><?= $lang['start']['openemail_apps_detail']; ?></p>
            <?php endif; ?>
          </div>
        </div>
      </div>
